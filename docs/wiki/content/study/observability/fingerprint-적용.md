...
| 여기서 다루는 것 | 개념 |
| --- | --- |
| 이슈가 갈리는 규칙 | [fingerprint](./개념/sentry#_2-fingerprint-—-이슈-그룹핑-키) |
| 코드 없이 푸는 길 | [서버측 규칙](./개념/sentry#코드를-안-고치는-길-—-서버측-규칙) |
| 제목은 왜 따로 손봐야 하나 | [이슈 제목](./개념/sentry#_3-이슈-제목-—-fingerprint가-못-바꾼다) |
| 이게 풀려야 알림을 건다 | [알림](./개념/sentry#_13-알림-alert) |
